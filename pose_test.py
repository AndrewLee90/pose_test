...
image_path = r'D:\INFO SECURITY\Pose_detection\spring_street_after.jpg'
# 이미지 출력 (결과파일 경로를 입력하세요)
output_path = r'D:\INFO SECURITY\Pose_detection\results'  # Ensure the output directory exists
